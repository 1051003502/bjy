...
public:
	enum class DWGSection
	{
		...
		APPINFOHISTORY, /*!< AcDb:AppInfoHistory (in R2007 may be a renamed section?*/
		EXTEDATA,       /*!< Extended Entity Data */
		PROXYGRAPHICS,  /*!< PROXY ENTITY GRAPHICS */
		EMPTY,          /* empty section in start */
	};
...
private:
    ...
    duint32 sizeC;
    duint32 sizeD;
    duint32 posC; /* position in compression buffer */
    duint32 posD; /* position in decompression buffer */
};
