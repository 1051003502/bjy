...
public:
	...
	virtual void addLType(const std::shared_ptr<DRW_LType>& data) = 0;
	/** Called for every layer. */
	virtual void addLayer(const std::shared_ptr<DRW_Layer>& data) = 0;
	/** Called for every dim style. */
	virtual void addDimStyle(const std::shared_ptr<DRW_Dimstyle>& data) = 0;
	/** Called for every VPORT table. */
	virtual void addVport(const std::shared_ptr<DRW_Vport>& data) = 0;
	/** Called for every text style. */
	virtual void addTextStyle(const std::shared_ptr<DRW_Textstyle>& data) = 0;
	/** Called for every AppId entry. */
	virtual void addAppId(const std::shared_ptr<DRW_AppId>& data) = 0;
	...
	/** Called for every attrib */
	virtual void addAttrib(const DRW_Attrib& data) = 0;

	/*Called for every attdef */
	virtual void addAttdef(const DRW_Attdef& data) = 0;
	 ...
	 */
	virtual void addDimRadius(const DRW_DimRadius* data) = 0;

	/**
	 * Called for every diametric dimension entity.
	 */
	virtual void addDimDiameter(const DRW_DimDiameter* data) = 0;
